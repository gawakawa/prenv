...
| <a name="input_db_image"></a> [db\_image](#input\_db\_image) | Postgres sidecar image with migration and seed SQL baked in via initdb. | `string` | `"postgres:18-alpine"` | no |
